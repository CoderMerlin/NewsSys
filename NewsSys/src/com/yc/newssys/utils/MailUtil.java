...
public class MailUtil {
    ...
    static String from = "hm573059382@163.com";
 
    static String user = "hm573059382@163.com";//发送者邮箱地址
 
    static String password = "huangmai";//密码
    ...
    {
        sendEmail("573059382@qq.com","邮件测试","hello");//收件人
